...
public class BookAncientKnowledgeCondition extends BookCondition {

    public ResourceLocation advancementId;
    public int knowledge;
    public Component advancement;
    public boolean hasAdvancement;
    public BookAncientKnowledgeCondition(Component component, int knowledge, ResourceLocation advancementId, boolean hasAdvancement) {
        super(component);
    ...
    public static BookAncientKnowledgeCondition fromJson(JsonObject json) {
        ...
        return new BookAncientKnowledgeCondition(tooltip, knowledge, advancementId, hasAdvancement);
    }
    ...
    public List<Component> getTooltip(BookConditionContext context) {
        ...
        list.add(Component.translatable("book.runicarts.condition.ancientknowledge.ln1", knowledge));
        list.add(Component.translatable("book.runicarts.condition.ancientknowledge.ln2", ClientPlayerData.getPlayerAncientKnowledge()));
        if (hasAdvancement) {
            list.add(Component.translatable("book.runicarts.condition.ancientknowledge.ln3", Component.translatable(makeDescriptionId("advancements", advancementId) + ".title")));
        }
        return list;
    }
    ...
    public ResourceLocation getType() {
        return new ResourceLocation(RunicArts.MOD_ID, "ancientknowledge");
    }
