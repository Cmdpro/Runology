...
import com.cmdpro.runicarts.screen.slot.SoulGemSlot;
...
public class DivinationTableMenu extends AbstractContainerMenu {
    ...
    public DivinationTableMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(MenuInit.DIVINATIONTABLE_MENU.get(), pContainerId);
        checkContainerSize(inv, 3);
        blockEntity = ((DivinationTableBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, BlockInit.DIVINATIONTABLE.get());
    }
