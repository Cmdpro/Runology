...
public class SmallShatterParticle extends TextureSheetParticle {
    public float startQuadSize;
    public float rot;
    protected SmallShatterParticle(ClientLevel level, double xCoord, double yCoord, double zCoord,
    ...
    public void render(VertexConsumer pBuffer, Camera pRenderInfo, float pPartialTicks) {
        ...
        super.render(RenderHandler.createBufferSource().getBuffer(RunologyRenderTypes.SHATTER_PARTICLE), pRenderInfo, pPartialTicks);
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new SmallShatterParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
