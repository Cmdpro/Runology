...
public class PlayerPowerPunchParticle extends TextureSheetParticle {
    public float startQuadSize;
    public float rot;
    protected PlayerPowerPunchParticle(ClientLevel level, double xCoord, double yCoord, double zCoord,
    ...
    public void render(VertexConsumer pBuffer, Camera pRenderInfo, float pPartialTicks) {
        ...
        super.render(RenderEvents.createShatterInsideBufferSource().getBuffer(RunologyRenderTypes.PLAYER_POWER_PARTICLE), pRenderInfo, pPartialTicks);
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new PlayerPowerPunchParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
