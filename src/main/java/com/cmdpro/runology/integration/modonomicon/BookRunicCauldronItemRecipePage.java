...
public class BookRunicCauldronItemRecipePage extends BookRecipePage<RunicCauldronItemRecipe> {
    ...
    @Override
    protected ItemStack getRecipeOutput(Level level, RunicCauldronItemRecipe recipe) {
