...
public class BookRunicCauldronFluidRecipePageRenderer extends BookRecipePageRenderer<RunicCauldronFluidRecipe, BookRunicCauldronFluidRecipePage> {
    public BookRunicCauldronFluidRecipePageRenderer(BookRunicCauldronFluidRecipePage page) {
        super(page);
    }
    ...
    @Override
    protected void drawRecipe(GuiGraphics guiGraphics, RunicCauldronFluidRecipe recipe, int recipeX, int recipeY, int mouseX, int mouseY, boolean second) {
        if (!second) {
        ...
        renderFluidStack(guiGraphics, recipeX + 68-8, recipeY + 12-8, mouseX, mouseY, new ForgeFluidHolder(recipe.getFluidOutput()), 1000);
    }
