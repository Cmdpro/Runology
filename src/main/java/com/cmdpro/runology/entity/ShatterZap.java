...
public class ShatterZap extends Entity {
    public int time;
    public ShatterZap(EntityType<ShatterZap> entityType, Level world) {
        super(entityType, world);
    }
    protected ShatterZap(EntityType<ShatterZap> entityType, Vec3 pos, Level world) {
        this(entityType, world);
        this.setPos(pos);

    }
    public ShatterZap(EntityType<ShatterZap> entityType, Vec3 pos, Level world, Entity victim) {
        this(entityType, pos, world);
        this.victimPos = victim.getBoundingBox().getCenter().toVector3f();
        entityData.set(VICTIMPOS, victimPos);
    }
    public ShatterZap(EntityType<ShatterZap> entityType, Vec3 pos, Level world, Vec3 victimPos) {
        this(entityType, pos, world);
    ...
    public static final EntityDataAccessor<Vector3f> VICTIMPOS = SynchedEntityData.defineId(ShatterZap.class, EntityDataSerializers.VECTOR3);

    @Override
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        builder.define(VICTIMPOS, new Vector3f());
    }
