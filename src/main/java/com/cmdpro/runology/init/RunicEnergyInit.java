...
public class RunicEnergyInit {
    ...
    public static final RegistryObject<RunicEnergyType> ENERGY = register("energy", () -> new RunicEnergyType(new Color(245, 202, 118), new ResourceLocation(Runology.MOD_ID, "fire")));
    public static final RegistryObject<RunicEnergyType> ICE = register("ice", () -> new RunicEnergyType(new Color(214, 240, 255), new ResourceLocation(Runology.MOD_ID, "water")));
    public static final RegistryObject<RunicEnergyType> PLANT = register("plant", () -> new RunicEnergyType(new Color(84, 195, 0), new ResourceLocation(Runology.MOD_ID, "earth")));
    public static final RegistryObject<RunicEnergyType> VOID = register("void", () -> new RunicEnergyType(new Color(146, 70, 156), new ResourceLocation(Runology.MOD_ID, "air")));
    public static final RegistryObject<RunicEnergyType> INSTABILITY = register("instability", () -> new RunicEnergyType(new Color(35, 35, 35)));
