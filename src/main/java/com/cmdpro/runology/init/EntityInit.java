...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<PrismaticBulletProjectile>> PRISMATICBULLET = ENTITY_TYPES.register("prismaticbullet", () -> EntityType.Builder.of((EntityType.EntityFactory<PrismaticBulletProjectile>) PrismaticBulletProjectile::new, MobCategory.MISC).sized(0.25F, 0.25F).build(Runology.MOD_ID + ":" + "prismaticbullet"));
}
